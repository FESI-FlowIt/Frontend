...
import { CalendarData, DAYS } from '@/interfaces/calendar';

const CalendarGrid = ({ data }: { data: CalendarData }) => {
  ...
  for (let date = 1; date <= daysInMonth; date++) {
    ...
    calendarCells.push(<CalendarCell key={date} date={date} goals={goalsOfTheDay} />);
  }
