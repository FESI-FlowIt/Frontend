...
import EmptyTodoGuide from './EmptyTodoGuide';
    ...
    <Modal isOpen onClose={onClose} size="timer">
      <div className="flex h-full flex-col">
        ...
        {allTodosEmpty ? (
          ...
          <div className="space-y-12 overflow-x-hidden overflow-y-auto pr-16">
            {goals.map(goal => {
                ...
                >
                  ...
                  >
                    <span className="text-body-m-20 text-text-02 flex items-center gap-12">
                      <span
                        className={`h-12 w-12 rounded-full ${getGoalTextColorClass(goal.color)}`}
                      />
                      {goal.title}
                    </span>
