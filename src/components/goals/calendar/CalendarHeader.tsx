...
const CalendarHeader: React.FC<CalendarHeaderProps> = ({
  ...
  return (
    <div className="flex h-48 items-center justify-center pt-36 pb-24">
      ...
      >
        <ArrowBackIcon className="text-snackbar" width={24} height={24} fill="currentColor" />
      </button>
      ...
      >
        <ArrowForwardIcon className="text-snackbar" width={24} height={24} fill="currentColor" />
      </button>
    </div>
  );
};
